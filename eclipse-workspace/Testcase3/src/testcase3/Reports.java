...
public class Reports {
	...
	void repo() throws InterruptedException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='iteReportECons']")));
		WebElement kotdetailss1=driver.findElement(By.xpath("//div[@id='iteReportECons']"));
		WebElement kotnumberrr1=kotdetailss1.findElement(By.xpath("//div[@id='iteReportECons']/table/tbody/tr[4]/td[2]"));
		String numberkot1=kotnumberrr1.getText();
		System.out.println("Kot number"+numberkot1);
		
		Thread.sleep(1000);
		WebElement items=driver.findElement(By.xpath("//div[@id='iteReportECons']"));
		WebElement item1=items.findElement(By.xpath("//div[@id='iteReportECons']/table/tbody/tr[4]/td[3]"));
		String item11=item1.getText();
		System.out.println("Item deleted"+item11);
		
		Thread.sleep(1000);
		WebElement qtyy=driver.findElement(By.xpath("//div[@id='iteReportECons']"));
		WebElement qtyy1=qtyy.findElement(By.xpath("//div[@id='iteReportECons']/table/tbody/tr[4]/td[7]"));
		String qty1=qtyy1.getText();
		System.out.println("Item qty"+qty1);
		
		Thread.sleep(1000);
		WebElement deleteuser=driver.findElement(By.xpath("//div[@id='iteReportECons']"));
		WebElement deleteuser1=deleteuser.findElement(By.xpath("//div[@id='iteReportECons']/table/tbody/tr[4]/td[14]"));
		String deleteuser11=deleteuser1.getText();
		System.out.println("Delete user:"+deleteuser11);
		...
		WebElement qtyy11=qty.findElement(By.xpath("//div[@id='iteReportECons']/div[1]/table/tbody/tr[3]/td[5]"));
		String qty2=qtyy11.getText();
